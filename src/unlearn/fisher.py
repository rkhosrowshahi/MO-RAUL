...
def fisher(data_loaders, model, criterion, args, wandb_run=None):
    """
    Fisher information-based unlearning method (single-shot).
    Note: This is a non-iterative method, so wandb logging is minimal.
    """
...
def fisher_new(data_loaders, model, criterion, args, wandb_run=None):
    """
    Fisher information-based unlearning method with Hessian (single-shot).
    Note: This is a non-iterative method, so wandb logging is minimal.
    """
    retain_loader = data_loaders["retain"]
