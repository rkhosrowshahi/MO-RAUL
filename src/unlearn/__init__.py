...
from .mojd import MO_JD_CE_CE, MO_JD_CE_HeldDist, MO_JD_CE_UniDist, MO_JD_CE_UniDist_Calib

def raw(data_loaders, model, criterion, args, mask=None, wandb_run=None):
    pass
...
def get_unlearn_method(name):
    ...
    if name == "raw":
        ...
        return RL_proximal
    elif name == "MO_JD_CE_CE":
        return MO_JD_CE_CE
    elif name == "MO_JD_CE_HeldDist":
        return MO_JD_CE_HeldDist
    elif name == "MO_JD_CE_UniDist":
        return MO_JD_CE_UniDist
    elif name == "MO_JD_CE_UniDist_Calib":
        return MO_JD_CE_UniDist_Calib
    else:
