...
def GA(train_loader, model, criterion, optimizer, epoch, args, total_steps=0, wandb_run=None):
    losses = AverageMeter()
    top1 = AverageMeter()
...
def GA_prune_bi(data_loaders, model, criterion, args, total_steps=1, wandb_run=None):
    best_sa = 0
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        total_steps, acc = GA(train_loader, model, criterion, optimizer, epoch, args, total_steps=total_steps, wandb_run=wandb_run)
